...
OpenLayers.Layer.Grid = OpenLayers.Class(OpenLayers.Layer.HTTPRequest, {
    ...
    transformDiv: function(scale) {
        ...
        var lcX = parseInt(this.map.layerContainerDiv.style.left, 10) || 0;
        var lcY = parseInt(this.map.layerContainerDiv.style.top, 10) || 0;
